...
- passo 4 - adicionar a calsse modo-escuro no body
- passo 5 - trocar a imagem do botão de alterar tema para lua

- objetivo 2 - quando clicar no botão de troca de tema, caso o body já tenha a classe modo-escuro, remover a calsse para mudar para o modo claro e mudar a imagem para o sol
- passo 6 - verificar se o body já tem a classe modo-escuro
- passo 7 - remocer a classe do modo-escuro do body
